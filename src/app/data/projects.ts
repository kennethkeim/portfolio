...
const projects = [
   {
      ...
      description: 'Abner Henry Fine Furniture needed a way to dynamically update their inventory from a third party supplier, who kept the inventory list in an excel file. I deployed a web server that parses inventory items from the excel file and serves it to their website.'
   }
];
